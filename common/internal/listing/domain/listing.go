...
func NewListing(authorID shared.UserID, title, description string, accessMode ListingAccessMode, hardwareSpec *shared.HardwareSpecification, price shared.Money) (*Listing, error) {
...
func NewListingWithID(id shared.ListingID, authorID shared.UserID, title, description string, accessMode ListingAccessMode, hardwareSpec *shared.HardwareSpecification, price shared.Money) (*Listing, error) {
	listing := &Listing{
		id:                    id,
		authorID:              authorID,
		title:                 title,
...
func (l *Listing) Price() shared.Money {
	return l.price
}
...
func (l *Listing) SetPrice(price shared.Money) {
	l.price = price
}
