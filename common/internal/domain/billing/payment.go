...
func NewOneTimePayment(billingAccountID shared.BillingAccountID, amount money.Money, listingID shared.ListingID, userID shared.UserID) (*Payment, error) {
...
func NewSubscriptionPayment(billingAccountID shared.BillingAccountID, amount money.Money, instanceID shared.InstanceID, periodEnd time.Time, paymentType SubscriptionPaymentType) (*Payment, error) {
	id := shared.PaymentID(shared.GenerateUUID())
...
func NewPaymentWithID(id shared.PaymentID, billingAccountID shared.BillingAccountID, amount money.Money, status PaymentStatus, kind PaymentKind, createdAt time.Time, paidAt *time.Time, oneTime *OneTimePaymentMetadata, subscription *SubscriptionPaymentMetadata) (*Payment, error) {
	payment := &Payment{
		id:                   id,
		billingAccountID:     billingAccountID,
		amount:               amount,
