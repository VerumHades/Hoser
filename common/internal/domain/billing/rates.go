...
func NewHardwareCostRate(cpuCost, ramCost, diskCost money.Money, validFrom time.Time, validTo *time.Time) (*HardwareCostRate, error) {
...
func NewHardwareCostRateWithID(id shared.HardwareCostRateID, cpuCost, ramCost, diskCost money.Money, validFrom time.Time, validTo *time.Time) (*HardwareCostRate, error) {
...
func (h *HardwareCostRate) CPUCost() money.Money {
	return h.cpuCost
}

// RAMCost returns the RAM cost.
func (h *HardwareCostRate) RAMCost() money.Money {
	return h.ramCost
}

// DiskCost returns the disk cost.
func (h *HardwareCostRate) DiskCost() money.Money {
	return h.diskCost
}
