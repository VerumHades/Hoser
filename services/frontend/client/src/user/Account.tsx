        ...
        <RequireLogin>
            <div className="h-full flex flex-col">
                ...
                <div className="flex h-screen bg-slate-50 dark:bg-gray-950">
                    {/* Sidebar */}
                    <aside
                        className={`fixed md:static z-20 top-0 left-0 bottom-0 w-64 border-r border-slate-200 dark:border-gray-800 p-4 bg-white dark:bg-gray-900 transform ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"
